...
class DatabaseService {
  ...
  //http://localhost:8080/qualitypatternmodel/databases/registration/
  ...
  //http://localhost:8080/qualitypatternmodel/databases/set/mydatabase/card_concrete_finalized
...
export default new DatabaseService(
  "http://localhost:8080/qualitypatternmodel/databases"
);
